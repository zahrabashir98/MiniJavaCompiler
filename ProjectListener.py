...
class ProjectListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ProjectParser#classDeclaration.
    def enterClassDeclaration(self, ctx):
        pass

    # Exit a parse tree produced by ProjectParser#classDeclaration.
    ...
    # Enter a parse tree produced by ProjectParser#parameterList.
    def enterParameterList(self, ctx):
        pass

    # Exit a parse tree produced by ProjectParser#parameterList.
